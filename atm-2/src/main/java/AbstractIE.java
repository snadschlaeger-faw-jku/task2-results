...
public abstract class AbstractIE {
	 ...
	 * @return
	 */
	protected abstract Object getConsequenceParameter(Clause consequence);

	protected abstract Object getConditionParameter(Clause condition);
	...
	protected abstract void setFactPropertyValue(Fact fact, Slot property, Object value);

	protected abstract String getFactPropertyName(Slot property);

	protected abstract void setConditionParameter(Clause condition, Object parameter);
	...
	protected abstract Object getFactPropertyValue(Fact fact, Slot property);
